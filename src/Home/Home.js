  ...
  return (
      <div className="Home">
          <div className="jumbotron jumbotron-fluid monJumbottron1">
                  <h1 className="display-4">Bienvenue sur PessiQuiz !</h1>
          ...
          <div className="jumbotron monJumbottron2 row">
              ...
              <div className="col-6">
                  <h4>Nos Quiz :</h4>
                  <p className="justify">
                      Premièrement sur notre application vous avez la possibilité de choisir different thème, "chimie" ou "sport", pour votre quiz.
